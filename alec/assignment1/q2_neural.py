...
def forward_backward_prop(data, labels, params, dimensions):
    ...
    # print(dSig2l[0])
    # exit()
    gradb2 = np.sum(dSig2, axis=0, keepdims=True)#np.dot(np.ones((1, dSig2.shape[0])), dSig2)
    # print(dSig2.shape)
    # print(b2.shape)
    # print(gradb2.shape)
    # exit()
    ...
    # print(dSig1.shape)
    # exit()
    gradb1 = np.sum(dSig1, axis=0, keepdims=True) #np.dot(np.ones((1, dSig1.shape[0])), dSig1)
    # print(dSig1.shape)
    # print(b1.shape)
    # print(gradb1.shape)
    # exit()
